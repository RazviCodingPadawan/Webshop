...
export default function Edit() {
  ...
  return <Container>
    ...
    <Row className="btn_login edit_btn"><Link to="/backoffice">⦑ Bakåt</Link></Row>
    <Row className="mb-3 edit_select"><Col><CategorySelect showAllOption bindTo={[s, 'chosenCategoryId']} /></Col></Row>
      ...
      || s.chosenCategoryId === product.categoryId
        ...
        <Col className="product_edit_card">
            <Col className="edit_col">
              <Row><h3 className="h3_edit detal_name">{name}</h3></Row>
            ...
            <Col className="col_price">
                ...
                <Row><p className="price_detal"><b>Pris:</b> {sweFormat(price)}</p></Row></Col>
            </Col>
    )}
  </Container>
}